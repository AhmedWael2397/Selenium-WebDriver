...
1. tests for existance of the objects in the login page ( username field , password field , login button) 
...
4. tests a scenario where user logs in with valid credentials and check for existance of a certain div in the home page 